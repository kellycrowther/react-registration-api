...
function createAvailability(availability) {
    ...
    for (var x = 0; x < availability.length; x++) {
        ...
        var startDateTime = availability[x].startDate + ' ' + availability[x].time;
        startDateTime = new Date(startDateTime);
        var endDateTime = availability[x].endDate + ' ' + availability[x].time;
        ...
        for (var currentDateTime = startDateTime.getTime(); currentDateTime < endDateTime.getTime() + mil; currentDateTime = currentDateTime + mil) {
            var currentDay = new Date(currentDateTime);
